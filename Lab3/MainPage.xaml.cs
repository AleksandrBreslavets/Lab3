...
namespace Lab3
{
    public partial class MainPage : ContentPage
    {
        ...
        private void AddItemSourses()
        {
            ...
            //courseorientationPicker.ItemsSource = _pickersData["CourseOrientation"];
            //managerinfoPicker.ItemsSource = _pickersData["ManagerInfo"];
        }
        ...
        private void UpdateFilters()
        {
            ...
            //courseorientationPicker.SelectedItem = null;
           // managerinfoPicker.SelectedItem = null;
            _dataToShow.Clear();
        ...
        private SearchCriteria FormCriteria()
        {
            ...
            //newCriteria.CourseOrientation = courseorientationPicker.SelectedItem != null ? courseorientationPicker.SelectedItem as string : string.Empty;
            //newCriteria.Mana = managerinfoPicker.SelectedItem != null ? managerinfoPicker.SelectedItem as string : string.Empty;
